...
1. Differences between using _sessions_ or _JSON Web Tokens_ for authentication.
    sessions are stored on the server sending a cookie and tokens are storeg locally using a token for access

2. What does `bcrypt` do to help us store passwords in a secure manner.
    it hashes the password.
3. How are unit tests different from integration and end-to-end testing.
    unit test simply test a small unti of code where integration and end to end tests test the functionality of the code section.

4. How _Test Driven Development_ changes the way we write applications and tests.
 with tdd we write the test first and then write the code. it allows us to test our code as we develope.
